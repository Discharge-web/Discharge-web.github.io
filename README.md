...
* [Таблица](https://discharge-web.github.io/projects/table_js/index.html) - Небольшая работа сделаная на скорую руку с использованием js. Это простая таблица, в которой можно сортировать, фильтровать, добавлять, удалять и редактировать фильмы. В работе использовались библиотеки tippy.js и animate.css для всплывающих подсказок.
